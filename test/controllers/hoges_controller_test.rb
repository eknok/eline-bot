...
class HogesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hoge" do
    assert_difference('Hoge.count') do
      post hoges_url, params: { hoge: { content: @hoge.content, keyword: @hoge.keyword, title: @hoge.title } }
    end
  ...
  test "should update hoge" do
    patch hoge_url(@hoge), params: { hoge: { content: @hoge.content, keyword: @hoge.keyword, title: @hoge.title } }
